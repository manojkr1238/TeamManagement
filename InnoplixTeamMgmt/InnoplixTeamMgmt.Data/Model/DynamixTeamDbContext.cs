...
{
    public partial class DynamixTeamDbContext : DbContext
    {
        public DynamixTeamDbContext()
        {
        }

        public DynamixTeamDbContext(DbContextOptions<DynamixTeamDbContext> options)
            : base(options)
        {
        }
